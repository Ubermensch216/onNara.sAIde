...
const ko = {
  ...
  'page.method.onnaraList': '온나라 문서 목록',
  ...
  'auto.noScreen': '온나라 화면을 연 탭에서 사용하세요.',
  'auto.readFailed': '화면을 읽지 못했습니다.',
  'auto.reading': '화면 확인 중…',
  'auto.selectedCount': '선택 {selected}건 / 전체 {total}건',
  'auto.detailScreen': '현재 문서',
  'auto.refresh': '다시 읽기',
  'auto.actions': '자동화 작업',
  'auto.downloadAttachments': '첨부 받기',
  'auto.downloadAttachmentsDesc': '선택한 문서의 첨부 파일을 모두 내려받습니다',
  'auto.selectDocuments': '목록에서 문서를 체크하세요',
  'auto.exportList': '목록 내보내기',
  'auto.exportListDesc': '현재 목록을 엑셀에서 여는 CSV 파일로 저장합니다',
  'auto.exportListNeedsList': '문서함 목록 화면에서 사용할 수 있습니다',
  'auto.queue': '작업 대기열 · {n}건',
  'auto.history': '실행 기록',
  'auto.clearHistory': '기록 지우기',
  'auto.empty': '아직 실행한 작업이 없습니다.',
  'auto.noModel': 'AI 모델 없이 동작합니다. 온나라 화면의 기존 기능만 사용합니다.',
  'auto.status.queued': '대기',
  'auto.status.running': '실행 중',
  'auto.status.done': '완료',
  'auto.status.failed': '실패',
  'auto.status.cancelled': '취소',
  'auto.kind.download-attachments': '첨부 받기',
  'auto.kind.export-list': '목록 내보내기',
  'auto.fromChat': 'AI 대화에서 요청',
  'auto.cancel': '취소',
  'auto.openFile': '파일 열기',
  'auto.openFolder': '폴더 열기',
  'auto.file.complete': '완료',
  'auto.file.in_progress': '내려받는 중',
  'auto.file.not_started': '시작 안 됨',
  'auto.file.failed': '실패',
} as const;
...
const en = {
  ...
  'page.method.onnaraList': 'OnNara document list',
  ...
  'auto.noScreen': 'Use this in a tab showing OnNara.',
  'auto.readFailed': "Couldn't read the screen.",
  'auto.reading': 'Checking the screen…',
  'auto.selectedCount': '{selected} selected of {total}',
  'auto.detailScreen': 'Current document',
  'auto.refresh': 'Read again',
  'auto.actions': 'Automation actions',
  'auto.downloadAttachments': 'Download attachments',
  'auto.downloadAttachmentsDesc': 'Download every attachment of the selected documents',
  'auto.selectDocuments': 'Check documents in the list',
  'auto.exportList': 'Export list',
  'auto.exportListDesc': 'Save the current list as a CSV file that opens in Excel',
  'auto.exportListNeedsList': 'Available on a document box list',
  'auto.queue': 'Queue · {n}',
  'auto.history': 'History',
  'auto.clearHistory': 'Clear history',
  'auto.empty': 'No automation has run yet.',
  'auto.noModel': 'Runs without the AI model, using only existing OnNara features.',
  ...
  'auto.kind.download-attachments': 'Download attachments',
  'auto.kind.export-list': 'Export list',
  'auto.fromChat': 'From AI chat',
  'auto.cancel': 'Cancel',
  'auto.openFile': 'Open file',
  'auto.openFolder': 'Open folder',
  'auto.file.complete': 'Done',
  'auto.file.in_progress': 'Downloading',
  'auto.file.not_started': 'Not started',
  'auto.file.failed': 'Failed',
