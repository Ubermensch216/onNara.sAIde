...
const ko = {
  ...
  'auto.currentScreen': '작업 대상',
  'auto.selected': '선택 {n}건',
  'auto.total': '전체 {n}건',
...
const en = {
  ...
  'auto.currentScreen': 'Target',
  'auto.selected': '{n} selected',
  'auto.total': '{n} total',
  ...
  'auto.queue': 'In progress',
  'auto.fileCount': '{n} files',
