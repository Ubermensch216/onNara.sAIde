...
const ko = {
  ...
  'inbox.notifyTitle': '접수함 · 오늘 볼 문서 {n}건',
  'inbox.command': '접수함 브리핑',
  'inbox.commandHint': '받은문서를 확인해 오늘 볼 것을 갈래로 나눕니다 (접수함 탭)',
  ...
  'opt.inbox.hourDesc': '이 시각 이후 브라우저를 처음 쓸 때 그날의 브리핑을 한 번 수행합니다. 그 밖의 때에는 접수함 탭의 "지금 확인"이나 @브리핑으로 직접 확인합니다.',
  'opt.inbox.target': '대상 화면',
  'opt.inbox.targetNone': '지정되지 않음',
  'opt.inbox.targetDesc': '온나라에서 공유/공람 > 받은문서 목록을 연 뒤, 사이드패널의 접수함 탭에서 지정합니다. 조회 조건까지 함께 기억합니다.',
  'opt.inbox.targetClear': '지정 해제',
  'opt.inbox.scope': '대상 범위',
  'opt.inbox.scopeAll': '전체 문서',
  'opt.inbox.scopeKeywords': '키워드가 걸리는 문서만',
  'opt.inbox.scopeDesc': '범위 밖 문서도 버리지 않고 접수함 탭에 접어 둡니다. 나중에 키워드를 넓히면 다시 올라옵니다.',
  ...
  'opt.inbox.readDesc': '기본값은 목록 표만 읽습니다. 본문을 열지 않으므로 문서는 미열람 그대로 남고, 브리핑 전후로 열람 상태가 바뀌지 않았음을 접수함 화면에 건수로 보여 줍니다.',
  ...
  'opt.inbox.retentionDesc': '접수함 기록은 공문 제목이 이 브라우저에 남는 유일한 자리입니다. 기간이 지난 기록은 자동으로 지웁니다.',
  ...
  'quality.kind.inbox-relevance': '접수함 분류',
...
const en = {
  ...
  'view.inbox': 'Inbox',
  'view.inboxLabel': 'Inbox · {n} to handle',

  /* ── Inbox briefing (N1) ── */
  'inbox.title': "Today's inbox",
  'inbox.checkNow': 'Check now',
  'inbox.checking': 'Checking…',
  'inbox.designate': 'Use this screen as the inbox',
  'inbox.notSet': 'No inbox screen selected yet',
  ...
  'inbox.notifyTitle': 'Inbox · {n} to read today',
  'inbox.command': 'Inbox briefing',
  'inbox.commandHint': 'Checks received documents and sorts what to read today (Inbox tab)',
  ...
  'opt.inbox.hourDesc': 'Runs once on the first browser use after this hour. At other times, use "Check now" in the Inbox tab or the @inbox command.',
  'opt.inbox.target': 'Target screen',
  'opt.inbox.targetNone': 'Not selected',
  'opt.inbox.targetDesc': 'Open the received-documents list in onNara, then select it from the Inbox tab in the side panel. The search conditions are remembered too.',
  ...
  'opt.inbox.scopeDesc': 'Documents outside the scope are kept, collapsed, in the Inbox tab. Widening the keywords brings them back.',
  ...
  'opt.inbox.readDesc': 'By default only the list table is read. Documents are never opened, so they stay unread, and the Inbox tab reports the unchanged read state as a count.',
  ...
  'opt.inbox.retentionDesc': 'The inbox ledger is the only place document titles are stored in this browser. Older records are deleted automatically.',
  ...
  'opt.inbox.clear': 'Delete all inbox records',
  ...
  'quality.kind.inbox-relevance': 'Inbox classification',
