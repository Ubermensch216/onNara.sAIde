...
const ko = {
  ...
  'composer.normal': '무엇이든 물어보세요  ( / 또는 @ 로 명령 )',
  ...
  'view.inbox': '공유/공람',
  'view.inboxLabel': '공유/공람 브리핑 · 처리할 문서 {n}건',

  /* ── 공유/공람 브리핑 (N1) ── */
  'inbox.title': '공유/공람 브리핑',
  'inbox.checkNow': '지금 확인',
  'inbox.checking': '확인 중…',
  'inbox.designate': '이 화면을 브리핑 대상으로 지정',
  'inbox.notSet': '브리핑할 화면이 지정되지 않았습니다',
  'inbox.notSetBody': '온나라에서 공유/공람 > 받은문서 목록을 연 뒤 아래 단추를 누르세요. 그 화면의 조회 조건까지 기억해, 다음부터는 목록을 열어 두지 않아도 확인합니다.',
  'inbox.never': '아직 확인하지 않았습니다',
  'inbox.lastRun': '{time} 확인 · 목록 {n}건',
  'inbox.newCount': '새 문서 {n}건',
  'inbox.readChanged': '열람 상태가 바뀐 문서 {n}건',
  'inbox.markedRead': '설정에 따라 {n}건을 읽기처리했습니다',
  'inbox.skipped': '지난 확인은 건너뛰었습니다: {reason}',
  'inbox.cat.deadline': '기한 임박',
  'inbox.cat.mine': '내 업무로 보임',
  'inbox.cat.notice': '단순 공람',
  'inbox.cat.filtered': '범위 밖',
  'inbox.filtered': '범위 밖 {n}건',
  ...
  'inbox.dismiss': '넘기기',
  'inbox.dismissHint': '넘기면 온나라 받은문서 목록에서 이 문서를 읽기처리해 미열람을 열람으로 바꿉니다. 되돌릴 수 없습니다.',
  'inbox.dismissing': '열람 처리 중…',
  'inbox.dismiss.noTab': '넘기면서 열람 처리하려면 온나라 받은문서 목록을 연 탭에서 눌러야 합니다.',
  'inbox.dismiss.failed': '읽기처리 결과를 목록에서 확인하지 못했습니다. 카드는 그대로 두었습니다. 온나라 목록을 새로 고쳐 상태를 확인하세요.',
  'inbox.attachment': '첨부',
  'inbox.readOnlyList': '본문을 열지 않고 목록만 읽습니다.',
  'inbox.notifyTitle': '공유/공람 · 오늘 볼 문서 {n}건',
  'inbox.command': '공유/공람 브리핑',
  'inbox.commandHint': '받은문서를 확인해 오늘 볼 것을 갈래로 나눕니다 (공유/공람 탭)',
  ...
  'opt.inbox.h': '공유/공람 브리핑',
  'opt.inbox.on': '자동 브리핑',
  'opt.inbox.onDesc':
    '켜면 온나라 받은문서 목록을 스스로 읽어 오늘 볼 문서를 갈래로 나눕니다. 브라우저가 실행 중이고 온나라에 로그인돼 있어야 동작하며, 사이드패널은 닫혀 있어도 됩니다.',
  'opt.inbox.interval': '확인 주기',
  'opt.inbox.intervalDaily': '하루 한 번',
  'opt.inbox.intervalMin': '{n}분마다',
  'opt.inbox.intervalHour': '{h}시간마다',
  'opt.inbox.intervalDesc': '주기를 정하면 아래 업무시간 안에서 그 간격마다 확인합니다. 이미 브리핑한 문서는 다시 알리지 않으므로, 주기를 짧게 해도 새 문서가 왔을 때만 알림이 뜹니다. 확인 한 번마다 백그라운드 탭이 잠깐 열립니다.',
  'opt.inbox.hour': '확인 시작 시각',
  'opt.inbox.hourDesc': '하루 한 번 모드에서는 이 시각 이후 브라우저를 처음 쓸 때 그날의 브리핑을 수행합니다. 주기 모드에서는 업무시간이 시작되는 시각입니다.',
  'opt.inbox.endHour': '확인 종료 시각',
  'opt.inbox.endHourDesc': '이 시각부터는 확인하지 않습니다. 주기 모드에서만 적용되며, 하루 한 번 모드는 시각에 관계없이 그날 한 번을 놓치지 않습니다.',
  'opt.inbox.skipWeekend': '주말에는 확인하지 않음',
  'opt.inbox.skipWeekendDesc': '토·일에는 주기 확인을 건너뜁니다. 하루 한 번 모드에는 적용되지 않습니다.',
  'opt.inbox.target': '대상 화면',
  'opt.inbox.targetNone': '지정되지 않음',
  'opt.inbox.targetDesc': '온나라에서 공유/공람 > 받은문서 목록을 연 뒤, 사이드패널의 공유/공람 탭에서 지정합니다. 조회 조건까지 함께 기억합니다.',
  'opt.inbox.targetClear': '지정 해제',
  'opt.inbox.scope': '대상 범위',
  'opt.inbox.scopeAll': '전체 문서',
  'opt.inbox.scopeKeywords': '키워드가 걸리는 문서만',
  'opt.inbox.scopeDesc': '범위 밖 문서도 버리지 않고 공유/공람 탭에 접어 둡니다. 나중에 키워드를 넓히면 다시 올라옵니다.',
  'opt.inbox.keywords': '포함 키워드',
  'opt.inbox.keywordsDesc': '쉼표나 줄바꿈으로 구분합니다. 전체 범위에서도 이 키워드가 걸리면 "내 업무로 보임"으로 분류합니다. 띄어쓰기와 괄호는 무시하고 대조합니다.',
  'opt.inbox.exclude': '제외 키워드',
  'opt.inbox.excludeDesc': '범위와 무관하게 먼저 적용됩니다. 포함 키워드보다 우선합니다.',
  'opt.inbox.read': '열람 처리',
  'opt.inbox.readKeep': '목록만 읽기 (미열람 유지)',
  'opt.inbox.readMark': '브리핑한 문서를 읽기처리 (열람으로 변경)',
  'opt.inbox.readDesc': '기본값은 목록 표만 읽습니다. 본문을 열지 않으므로 문서는 미열람 그대로 남습니다. 브리핑 전후로 열람 상태가 바뀐 문서가 있으면 그 건수를 공유/공람 탭에 알립니다.',
  'opt.inbox.readWarn': '받은문서 목록에서 문서를 체크하고 읽기처리를 누릅니다. 온나라 서버에 열람 기록이 남으며, 확장은 이를 되돌릴 수 없습니다. 받은문서 목록을 보고 있는 탭에서 확인할 때만 동작합니다.',
  'opt.inbox.openLimit': '한 번에 읽기처리할 문서 수',
  'opt.inbox.openLimitDesc': '상한을 넘는 문서는 읽기처리하지 않습니다.',
  'opt.inbox.retention': '기록 보관 기간(일)',
  'opt.inbox.retentionDesc': '브리핑 기록은 공문 제목이 이 브라우저에 남는 유일한 자리입니다. 기간이 지난 기록은 자동으로 지웁니다.',
  'opt.inbox.stored': '보관 중인 기록',
  'opt.inbox.storedValue': '문서 {n}건 · 브리핑한 문서 {briefed}건',
  'opt.inbox.storedDesc': '모두 이 브라우저 안에만 있으며 밖으로 나가지 않습니다.',
  'opt.inbox.clear': '브리핑 기록 모두 삭제',
  ...
  /* ── 첨부 파일 저장 (B5) ── */
  'opt.files.h': '첨부 파일 저장',
  'opt.files.naming': '파일 이름',
  'opt.files.naming.normalized': '보고일자_공문제목_원래이름',
  ...
  'quality.kind.inbox-relevance': '공유/공람 분류',
  ...
  'auto.refresh': '다시 읽기',
  'auto.actions': '실행할 작업',
  'auto.targetMode.attachments': '첨부만',
  'auto.targetMode.body': '본문만',
  'auto.targetMode.all': '본문+첨부',
  'auto.docCount': '{n}건',
  'auto.downloadAttachments': '첨부 받기',
  'auto.downloadAttachmentsDesc': '선택한 문서의 첨부 파일을 모두 내려받습니다',
  'auto.downloadBody': '본문 받기 (PDF)',
  'auto.downloadBodyDesc': '선택한 문서의 본문을 PDF 파일로 내려받습니다',
  'auto.downloadAll': '본문 + 첨부 받기',
  'auto.downloadAllDesc': '선택한 문서의 본문(PDF)과 첨부 파일을 모두 내려받습니다',
  ...
  'auto.kind.download-body': '본문 받기',
  'auto.kind.download-all': '본문+첨부 받기',
  'auto.kind.summarize': '문서별 요약',
  'auto.kind.actions': '핵심·조치사항',
  'auto.queuedWait': '작업 대기열에서 차례를 기다리는 중입니다',
  'auto.docsAnalyzed': '문서 {n}건 분석 완료',
  'auto.docsAnalyzedCached': '문서 {n}건 분석 완료 (그중 {cached}건은 이전 결과 재사용)',
...
const en = {
  ...
  'composer.normal': 'Ask me anything  ( / or @ for commands )',
  ...
  'composer.opensInbox': 'Shared docs tab',
  ...
  'view.inbox': 'Shared',
  'view.inboxLabel': 'Shared-document briefing · {n} to handle',

  /* ── Shared-document briefing (N1) ── */
  'inbox.title': 'Shared-document briefing',
  'inbox.checkNow': 'Check now',
  'inbox.checking': 'Checking…',
  'inbox.designate': 'Use this screen for the briefing',
  'inbox.notSet': 'No briefing screen selected yet',
  'inbox.notSetBody': 'Open the received-documents list in onNara, then press the button below. The search conditions are remembered, so later checks work without keeping the list open.',
  'inbox.never': 'Not checked yet',
  'inbox.lastRun': 'Checked {time} · {n} rows',
  'inbox.newCount': '{n} new',
  'inbox.readChanged': '{n} documents changed read state',
  'inbox.markedRead': 'Marked {n} documents as read, per your setting',
  'inbox.skipped': 'Last check was skipped: {reason}',
  'inbox.cat.deadline': 'Due soon',
  'inbox.cat.mine': 'Looks like mine',
  'inbox.cat.notice': 'For information',
  'inbox.cat.filtered': 'Out of scope',
  'inbox.filtered': '{n} out of scope',
  ...
  'inbox.dismiss': 'Skip',
  'inbox.dismissHint': 'Skipping runs "Mark as read" on this document in the onNara received list. This cannot be undone.',
  'inbox.dismissing': 'Marking as read…',
  'inbox.dismiss.noTab': 'To skip and mark as read, press this from the tab showing the onNara received-documents list.',
  'inbox.dismiss.failed': 'Could not confirm the document was marked read in the list. The card was kept. Refresh the onNara list to check.',
  'inbox.attachment': 'Attachment',
  'inbox.readOnlyList': 'Reads the list only; documents are not opened.',
  'inbox.notifyTitle': 'Shared documents · {n} to read today',
  'inbox.command': 'Shared-document briefing',
  'inbox.commandHint': 'Checks received documents and sorts what to read today (Shared docs tab)',
  ...
  'opt.inbox.h': 'Shared-document briefing',
  'opt.inbox.on': 'Automatic briefing',
  'opt.inbox.onDesc':
    'Reads the onNara received-documents list on its own and sorts what to read today. The browser must be running and signed in to onNara; the side panel may stay closed.',
  'opt.inbox.interval': 'Check every',
  'opt.inbox.intervalDaily': 'Once a day',
  'opt.inbox.intervalMin': '{n} minutes',
  'opt.inbox.intervalHour': '{h} hours',
  'opt.inbox.intervalDesc': 'With an interval set, checks that often within the working hours below. Documents already briefed are never announced again, so a short interval still only notifies you when something new arrives. Each check opens a background tab briefly.',
  'opt.inbox.hour': 'Start checking at',
  'opt.inbox.hourDesc': 'In once-a-day mode, the briefing runs on the first browser use after this hour. In interval mode, this is when the working-hours window opens.',
  'opt.inbox.endHour': 'Stop checking at',
  'opt.inbox.endHourDesc': 'No checks from this hour on. Applies to interval mode only — once-a-day mode never loses its one run of the day.',
  'opt.inbox.skipWeekend': 'Skip weekends',
  'opt.inbox.skipWeekendDesc': 'No interval checks on Saturday and Sunday. Does not apply to once-a-day mode.',
  'opt.inbox.target': 'Target screen',
  'opt.inbox.targetNone': 'Not selected',
  'opt.inbox.targetDesc': 'Open the received-documents list in onNara, then select it from the Shared docs tab in the side panel. The search conditions are remembered too.',
  'opt.inbox.targetClear': 'Clear selection',
  'opt.inbox.scope': 'Scope',
  'opt.inbox.scopeAll': 'All documents',
  'opt.inbox.scopeKeywords': 'Only documents matching keywords',
  'opt.inbox.scopeDesc': 'Documents outside the scope are kept, collapsed, in the Shared docs tab. Widening the keywords brings them back.',
  'opt.inbox.keywords': 'Include keywords',
  'opt.inbox.keywordsDesc': 'Separate with commas or new lines. Even in the all-documents scope, a match marks the document as "looks like mine". Spacing and brackets are ignored when matching.',
  'opt.inbox.exclude': 'Exclude keywords',
  'opt.inbox.excludeDesc': 'Applied first, regardless of scope, and take precedence over include keywords.',
  'opt.inbox.read': 'Read state',
  'opt.inbox.readKeep': 'Read the list only (stay unread)',
  'opt.inbox.readMark': 'Mark briefed documents as read',
  'opt.inbox.readDesc': 'By default only the list table is read. Documents are never opened, so they stay unread. If any read state changed across a briefing, the Shared docs tab reports that count.',
  'opt.inbox.readWarn': 'Checks the documents in the received list and presses "Mark as read". onNara records them as read, and the extension cannot undo that. Works only when checking from a tab showing the received-documents list.',
  'opt.inbox.openLimit': 'Documents to mark read at once',
  'opt.inbox.openLimitDesc': 'Documents beyond the limit are not marked read.',
  'opt.inbox.retention': 'Keep records for (days)',
  'opt.inbox.retentionDesc': 'The briefing ledger is the only place document titles are stored in this browser. Older records are deleted automatically.',
  'opt.inbox.stored': 'Stored records',
  'opt.inbox.storedValue': '{n} documents · {briefed} briefed',
  'opt.inbox.storedDesc': 'Everything stays in this browser and never leaves it.',
  'opt.inbox.clear': 'Delete all briefing records',
  ...
  /* ── Attachment files (B5) ── */
  'opt.files.h': 'Attachment files',
  'opt.files.naming': 'File name',
  'opt.files.naming.normalized': 'date_document_originalname',
  ...
  'quality.kind.inbox-relevance': 'Shared-document classification',
  ...
  'auto.targetMode.attachments': 'Attachments only',
  'auto.targetMode.body': 'Body only',
  'auto.targetMode.all': 'Body + Attachments',
  'auto.docCount': '{n}',
  ...
  'auto.downloadBody': 'Download body (PDF)',
  'auto.downloadBodyDesc': 'Download the body of the selected documents as PDF',
  'auto.downloadAll': 'Download body & attachments',
  'auto.downloadAllDesc': 'Download both the body (PDF) and attachments of the selected documents',
  ...
  'auto.kind.download-body': 'Download body',
  'auto.kind.download-all': 'Download body & attachments',
  'auto.kind.summarize': 'Per-document summary',
  'auto.kind.actions': 'Key points & actions',
  'auto.queuedWait': 'Waiting in the job queue',
  'auto.docsAnalyzed': 'Analyzed {n} document(s)',
  'auto.docsAnalyzedCached': 'Analyzed {n} document(s) — {cached} reused from earlier results',
