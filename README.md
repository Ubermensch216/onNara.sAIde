...
* **지난 기한을 숨기지 않음**: 기한 지남 · 오늘 · 이번 주 · 나중 · 기한 미정 구간으로 나누어 보여 주며, 놓친 기한은 맨 위에 `D+n`으로 남습니다.
...
* **목록 보기**: 기한 지남 · 오늘 · 이번 주 · 나중 · 기한 미정으로 나뉘며, 완료 항목은 접혀 있습니다. 탭 이름 옆 배지에는 이번 주까지의 임박 건수가 표시됩니다.
...
# 전체 단위 및 통합 테스트 실행 (53개 파일, 549개 테스트)
npm test
