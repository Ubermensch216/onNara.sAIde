...
사이드패널은 상단의 3대 탭(**AI 도우미**, **일정**, **도구**)으로 유기적으로 구성되어 있으며, **AI** 탭은 현재 온나라 화면의 문서를 읽고 지능적인 요약, 질의응답, 비교 분석을 수행하는 메인 작업 공간입니다.
...
* **상단 헤더(Header) 및 탭 구성**:
  ...
  * 상단 탭 전환 막대에서 **AI**, **일정**(기한 임박 배지 표시), **도구** 탭을 클릭하여 즉시 전환할 수 있습니다.
...
| **`@`** | **다른 탭에 남는 것을 다루는** 명령입니다. 일정 항목, 다운로드 작업처럼 대화가 끝나도 남는 것들입니다. | `@일정` (일정 탭) · `@첨부` (도구 탭) |
...
# 전체 단위 및 통합 테스트 실행 (69개 파일, 788개 테스트 · 2026-09-20 확인)
npm test
...
* 🧭 **서비스 진단 및 개선 제안 (컨설팅 보고)**: [`docs/service-review-2026-09-20.md`](docs/service-review-2026-09-20.md)
