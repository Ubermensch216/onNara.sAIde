...
| S07 | 기한·후속조치 보드 | S01 결과 | 사용자 확인 후 등록, 공문식 날짜 파서, D-day, Edge 실행 중 알림 | 4 |
...
| P4-4 | S07 기한·후속조치 보드 | 공문식 날짜 파서, 사용자 확인 등록, D-day·알림 | 날짜 파서 테스트, 알림 권한 안내 |
...
1. P0-5: 온나라 시험계정 화면 HTML 저장(담당자 협조).
2. P0-4: 범정부 AI 공통기반 시험 API 키 준비.
3. P0-7: 비식별 공문 표본 20~50건과 초기 대상 사용자 확정.
4. P0-1~P0-3 착수: 새 프로젝트 생성, Edge 빌드, Ollama 0.34.1 실측.
