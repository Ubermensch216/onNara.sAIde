...
if (-not $ChromePath) {
  if (Test-Path 'C:\Program Files\Google\Chrome\Application\chrome.exe') {
    ...
    throw "Chrome or Edge executable not found. Please provide -ChromePath argument."
  }
}
if (-not (Test-Path -LiteralPath $ChromePath)) { throw "Browser executable not found: $ChromePath" }
